...
1. `docs/00_Project/PROJECT_CONTEXT.md`
2. `docs/00_Project/SYSTEM_OVERVIEW.md`
3. `docs/00_Project/REPOSITORY_MAP.md`
4. `docs/01_Architecture/PLATFORM_ARCHITECTURE.md`
5. 與任務相關的模組文件
6. `docs/04_AI/AI_RULES.md`
